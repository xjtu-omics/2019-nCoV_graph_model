...
meanIncubation=3								## mean incubation period
familyMemberNumber=3							## mean family member number
busPassangerNum=40								## mean passanger number of a bus
taxiPassangerNum=3								## mean passanger number of a taxi
subwayPassangerNum=1000							## mean passanger number of a subway
taxiTouchNumber=2								## mean touch number in a taxi
busTouchNumber=5								## mean touch number in a bus
subwayTouchNumber=5								## mean touch number in a subway
hospitalTouchNumber=20							## mean touch number in a hospital
familyTouchNumber=3								## mean touch number in a family / family car
publicTouchNumber=10							## mean touch number in a public region
treatLastTime=21								## mean the treatment days in hospital
panicFold=2										## mean the fold change of transportation passangers when people panic
